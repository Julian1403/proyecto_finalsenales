...
#%%Creamos las funciones necesarias para el cumplimiento de los puntos planteados
...
def filter_signal(data, fs, freqs):
    ...
    #Retornamos la señal sin los ciclos cardiacos
...
def create_dataframe(path, name_dataframe):
    ...
    dataframe.to_csv(name_dataframe)
    return 
...
#los sonidos
wavf.write("Filtro_Fir2.wav", fs, data1*100)
wavf.write("Filtro_Wavelet2.wav", fs, f_w*100)
...
frame = create_dataframe(r"Respiratory_Sound_Database\Respiratory_Sound_Database\audio_and_txt_files", "dataframe.cvs")
print(frame.to_string())

#%%Mostramos los histogramas y calculamos la U Mann whitney 
#para visualizar los histogramas es necesario comentar los demás literales y dejar solo este.
